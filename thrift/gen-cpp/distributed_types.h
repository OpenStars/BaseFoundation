...
class TDataMovingStatus : public virtual ::apache::thrift::TBase {
 public:
  ...
  TDataMovingStatus(const TDataMovingStatus&) noexcept;
  TDataMovingStatus& operator=(const TDataMovingStatus&) noexcept;
  TDataMovingStatus() noexcept
                    : fromHash(0),
                      toHash(0),
                      totalItem(0),
                      numChecked(0),
  ...
  virtual ~TDataMovingStatus() noexcept;
  THashType fromHash;
  THashType toHash;
  int64_t totalItem;
  int64_t numChecked;
 ...
 public:
  ...
  TBackendInfo() noexcept
               : host(),
                 ...
                 startRange(0),
                 weight(0),
                 status(static_cast<TBackendStatus::type>(0)),
                 servicePath() {
  }
