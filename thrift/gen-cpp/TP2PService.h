...
class TP2PServiceIfSingletonFactory : virtual public TP2PServiceIfFactory {
 public:
  TP2PServiceIfSingletonFactory(const boost::shared_ptr<TP2PServiceIf>& iface) : iface_(iface) {}
 ...
 protected:
  boost::shared_ptr<TP2PServiceIf> iface_;
};
...
class TP2PServiceClient : virtual public TP2PServiceIf, public TBackendManagerServiceClient {
 public:
  TP2PServiceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
    TBackendManagerServiceClient(prot, prot) {}
  TP2PServiceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :    TBackendManagerServiceClient(iprot, oprot) {}
...
class TP2PServiceProcessor : public TBackendManagerServiceProcessor {
 ...
 public:
  TP2PServiceProcessor(boost::shared_ptr<TP2PServiceIf> iface) :
...
class TP2PServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  TP2PServiceProcessorFactory(const ::boost::shared_ptr< TP2PServiceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< TP2PServiceIfFactory > handlerFactory_;
};

class TP2PServiceMultiface : virtual public TP2PServiceIf, public TBackendManagerServiceMultiface {
 public:
  TP2PServiceMultiface(std::vector<boost::shared_ptr<TP2PServiceIf> >& ifaces) : ifaces_(ifaces) {
    std::vector<boost::shared_ptr<TP2PServiceIf> >::iterator iter;
 ...
 protected:
  std::vector<boost::shared_ptr<TP2PServiceIf> > ifaces_;
  TP2PServiceMultiface() {}
  void add(boost::shared_ptr<TP2PServiceIf> iface) {
...
class TP2PServiceConcurrentClient : virtual public TP2PServiceIf, public TBackendManagerServiceConcurrentClient {
 public:
  TP2PServiceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
    TBackendManagerServiceConcurrentClient(prot, prot) {}
  TP2PServiceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :    TBackendManagerServiceConcurrentClient(iprot, oprot) {}
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> getInputProtocol() {
    return piprot_;
  }
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> getOutputProtocol() {
