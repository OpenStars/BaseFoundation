...
class MonitorReadServiceIfSingletonFactory : virtual public MonitorReadServiceIfFactory {
 public:
  MonitorReadServiceIfSingletonFactory(const ::apache::thrift::stdcxx::shared_ptr<MonitorReadServiceIf>& iface) : iface_(iface) {}
 ...
 protected:
  ::apache::thrift::stdcxx::shared_ptr<MonitorReadServiceIf> iface_;
};
...
class MonitorReadServiceClient : virtual public MonitorReadServiceIf, public  ::openstars::base::OpenBaseServiceClient {
 public:
  MonitorReadServiceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
     ::openstars::base::OpenBaseServiceClient(prot, prot) {}
  MonitorReadServiceClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :     ::openstars::base::OpenBaseServiceClient(iprot, oprot) {}
...
class MonitorReadServiceProcessor : public  ::openstars::base::OpenBaseServiceProcessor {
 ...
 public:
  MonitorReadServiceProcessor(::apache::thrift::stdcxx::shared_ptr<MonitorReadServiceIf> iface) :
...
class MonitorReadServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  MonitorReadServiceProcessorFactory(const ::apache::thrift::stdcxx::shared_ptr< MonitorReadServiceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::apache::thrift::stdcxx::shared_ptr< MonitorReadServiceIfFactory > handlerFactory_;
};

class MonitorReadServiceMultiface : virtual public MonitorReadServiceIf, public  ::openstars::base::OpenBaseServiceMultiface {
 public:
  MonitorReadServiceMultiface(std::vector<apache::thrift::stdcxx::shared_ptr<MonitorReadServiceIf> >& ifaces) : ifaces_(ifaces) {
    std::vector<apache::thrift::stdcxx::shared_ptr<MonitorReadServiceIf> >::iterator iter;
 ...
 protected:
  std::vector<apache::thrift::stdcxx::shared_ptr<MonitorReadServiceIf> > ifaces_;
  MonitorReadServiceMultiface() {}
  void add(::apache::thrift::stdcxx::shared_ptr<MonitorReadServiceIf> iface) {
...
class MonitorReadServiceConcurrentClient : virtual public MonitorReadServiceIf, public  ::openstars::base::OpenBaseServiceConcurrentClient {
 public:
  MonitorReadServiceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
     ::openstars::base::OpenBaseServiceConcurrentClient(prot, prot) {}
  MonitorReadServiceConcurrentClient(apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :     ::openstars::base::OpenBaseServiceConcurrentClient(iprot, oprot) {}
  apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> getInputProtocol() {
    return piprot_;
  }
  apache::thrift::stdcxx::shared_ptr< ::apache::thrift::protocol::TProtocol> getOutputProtocol() {
