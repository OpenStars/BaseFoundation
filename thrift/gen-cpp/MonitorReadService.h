...
class MonitorReadServiceIfFactory : virtual public  ::openstars::base::OpenBaseServiceIfFactory {
 public:
  ...
  virtual MonitorReadServiceIf* getHandler(const ::apache::thrift::TConnectionInfo& connInfo) override = 0;
...
class MonitorReadServiceIfSingletonFactory : virtual public MonitorReadServiceIfFactory {
 public:
  MonitorReadServiceIfSingletonFactory(const ::std::shared_ptr<MonitorReadServiceIf>& iface) : iface_(iface) {}
  virtual ~MonitorReadServiceIfSingletonFactory() {}

  virtual MonitorReadServiceIf* getHandler(const ::apache::thrift::TConnectionInfo&) override {
    return iface_.get();
  }
  virtual void releaseHandler( ::openstars::base::OpenBaseServiceIf* /* handler */) override {}

 protected:
  ::std::shared_ptr<MonitorReadServiceIf> iface_;
};
...
class MonitorReadServiceNull : virtual public MonitorReadServiceIf , virtual public  ::openstars::base::OpenBaseServiceNull {
 public:
  ...
  void getCurrentStat(systemStat& /* _return */) override {
    return;
  }
  void getStat(systemStat& /* _return */, const int32_t /* seconds */) override {
    return;
  }
};
...
class MonitorReadService_getCurrentStat_args {
 public:
  ...
  MonitorReadService_getCurrentStat_args(const MonitorReadService_getCurrentStat_args&) noexcept;
  MonitorReadService_getCurrentStat_args& operator=(const MonitorReadService_getCurrentStat_args&) noexcept;
  MonitorReadService_getCurrentStat_args() noexcept {
  }

  virtual ~MonitorReadService_getCurrentStat_args() noexcept;
...
class MonitorReadService_getCurrentStat_pargs {
 public:
  ...
  virtual ~MonitorReadService_getCurrentStat_pargs() noexcept;
...
class MonitorReadService_getCurrentStat_result {
 public:
  ...
  MonitorReadService_getCurrentStat_result() noexcept {
  }

  virtual ~MonitorReadService_getCurrentStat_result() noexcept;
  systemStat success;
  InvalidOperation e;
...
class MonitorReadService_getCurrentStat_presult {
 public:
  ...
  virtual ~MonitorReadService_getCurrentStat_presult() noexcept;
  systemStat* success;
  InvalidOperation e;
...
class MonitorReadService_getStat_args {
 public:
  ...
  MonitorReadService_getStat_args(const MonitorReadService_getStat_args&) noexcept;
  MonitorReadService_getStat_args& operator=(const MonitorReadService_getStat_args&) noexcept;
  MonitorReadService_getStat_args() noexcept
                                  : seconds(0) {
  }

  virtual ~MonitorReadService_getStat_args() noexcept;
  int32_t seconds;
...
class MonitorReadService_getStat_pargs {
 public:
  ...
  virtual ~MonitorReadService_getStat_pargs() noexcept;
...
class MonitorReadService_getStat_result {
 public:
  ...
  MonitorReadService_getStat_result() noexcept {
  }

  virtual ~MonitorReadService_getStat_result() noexcept;
  systemStat success;
  InvalidOperation e;
...
class MonitorReadService_getStat_presult {
 public:
  ...
  virtual ~MonitorReadService_getStat_presult() noexcept;
  systemStat* success;
  InvalidOperation e;
...
class MonitorReadServiceClient : virtual public MonitorReadServiceIf, public  ::openstars::base::OpenBaseServiceClient {
 public:
  MonitorReadServiceClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
     ::openstars::base::OpenBaseServiceClient(prot, prot) {}
  MonitorReadServiceClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :     ::openstars::base::OpenBaseServiceClient(iprot, oprot) {}
...
class MonitorReadServiceProcessor : public  ::openstars::base::OpenBaseServiceProcessor {
 ...
 public:
  MonitorReadServiceProcessor(::std::shared_ptr<MonitorReadServiceIf> iface) :
...
class MonitorReadServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  MonitorReadServiceProcessorFactory(const ::std::shared_ptr< MonitorReadServiceIfFactory >& handlerFactory) noexcept :
      handlerFactory_(handlerFactory) {}

  ::std::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) override;

 protected:
  ::std::shared_ptr< MonitorReadServiceIfFactory > handlerFactory_;
};

class MonitorReadServiceMultiface : virtual public MonitorReadServiceIf, public  ::openstars::base::OpenBaseServiceMultiface {
 public:
  MonitorReadServiceMultiface(std::vector<std::shared_ptr<MonitorReadServiceIf> >& ifaces) : ifaces_(ifaces) {
    std::vector<std::shared_ptr<MonitorReadServiceIf> >::iterator iter;
 ...
 protected:
  std::vector<std::shared_ptr<MonitorReadServiceIf> > ifaces_;
  MonitorReadServiceMultiface() {}
  void add(::std::shared_ptr<MonitorReadServiceIf> iface) {
...
class MonitorReadServiceConcurrentClient : virtual public MonitorReadServiceIf, public  ::openstars::base::OpenBaseServiceConcurrentClient {
 public:
  MonitorReadServiceConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> prot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) :
     ::openstars::base::OpenBaseServiceConcurrentClient(prot, prot, sync) {}
  MonitorReadServiceConcurrentClient(std::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, std::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot, std::shared_ptr<::apache::thrift::async::TConcurrentClientSyncInfo> sync) :     ::openstars::base::OpenBaseServiceConcurrentClient(iprot, oprot, sync) {}
  std::shared_ptr< ::apache::thrift::protocol::TProtocol> getInputProtocol() {
    return piprot_;
  }
  std::shared_ptr< ::apache::thrift::protocol::TProtocol> getOutputProtocol() {
