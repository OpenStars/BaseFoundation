...
::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > StorageMonitorServiceProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< StorageMonitorServiceIfFactory > cleanup(handlerFactory_);
  ::apache::thrift::stdcxx::shared_ptr< StorageMonitorServiceIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::apache::thrift::stdcxx::shared_ptr< ::apache::thrift::TProcessor > processor(new StorageMonitorServiceProcessor(handler));
  return processor;
}
