...
class TNodeServiceBaseIfSingletonFactory : virtual public TNodeServiceBaseIfFactory {
 public:
  TNodeServiceBaseIfSingletonFactory(const boost::shared_ptr<TNodeServiceBaseIf>& iface) : iface_(iface) {}
 ...
 protected:
  boost::shared_ptr<TNodeServiceBaseIf> iface_;
};
...
class TNodeServiceBaseClient : virtual public TNodeServiceBaseIf {
 public:
  TNodeServiceBaseClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  TNodeServiceBaseClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class TNodeServiceBaseProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  TNodeServiceBaseProcessor(boost::shared_ptr<TNodeServiceBaseIf> iface) :
    iface_(iface) {
...
class TNodeServiceBaseProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  TNodeServiceBaseProcessorFactory(const ::boost::shared_ptr< TNodeServiceBaseIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< TNodeServiceBaseIfFactory > handlerFactory_;
};

class TNodeServiceBaseMultiface : virtual public TNodeServiceBaseIf {
 public:
  TNodeServiceBaseMultiface(std::vector<boost::shared_ptr<TNodeServiceBaseIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~TNodeServiceBaseMultiface() {}
 protected:
  std::vector<boost::shared_ptr<TNodeServiceBaseIf> > ifaces_;
  TNodeServiceBaseMultiface() {}
  void add(boost::shared_ptr<TNodeServiceBaseIf> iface) {
...
class TNodeServiceBaseConcurrentClient : virtual public TNodeServiceBaseIf {
 public:
  TNodeServiceBaseConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  TNodeServiceBaseConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
