...
const std::map<int, const char*> _service_status_VALUES_TO_NAMES(::apache::thrift::TEnumIterator(6, _kservice_statusValues, _kservice_statusNames), ::apache::thrift::TEnumIterator(-1, NULL, NULL));
