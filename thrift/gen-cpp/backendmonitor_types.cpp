...
opStat::opStat(const opStat& other2) noexcept {
...
opStat& opStat::operator=(const opStat& other3) noexcept {
...
storageStat::~storageStat() noexcept {
}
...
storageStat::storageStat(const storageStat& other4) noexcept {
  count = other4.count;
  sizeKb = other4.sizeKb;
  minSizeKb = other4.minSizeKb;
  __isset = other4.__isset;
}
storageStat& storageStat::operator=(const storageStat& other5) noexcept {
  count = other5.count;
...
backendStat::~backendStat() noexcept {
}
