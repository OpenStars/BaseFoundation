...
class TBackendManagerServiceIfSingletonFactory : virtual public TBackendManagerServiceIfFactory {
 public:
  TBackendManagerServiceIfSingletonFactory(const boost::shared_ptr<TBackendManagerServiceIf>& iface) : iface_(iface) {}
 ...
 protected:
  boost::shared_ptr<TBackendManagerServiceIf> iface_;
};
...
class TBackendManagerServiceClient : virtual public TBackendManagerServiceIf {
 public:
  TBackendManagerServiceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  TBackendManagerServiceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
...
class TBackendManagerServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  TBackendManagerServiceProcessor(boost::shared_ptr<TBackendManagerServiceIf> iface) :
    iface_(iface) {
...
class TBackendManagerServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  TBackendManagerServiceProcessorFactory(const ::boost::shared_ptr< TBackendManagerServiceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< TBackendManagerServiceIfFactory > handlerFactory_;
};

class TBackendManagerServiceMultiface : virtual public TBackendManagerServiceIf {
 public:
  TBackendManagerServiceMultiface(std::vector<boost::shared_ptr<TBackendManagerServiceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~TBackendManagerServiceMultiface() {}
 protected:
  std::vector<boost::shared_ptr<TBackendManagerServiceIf> > ifaces_;
  TBackendManagerServiceMultiface() {}
  void add(boost::shared_ptr<TBackendManagerServiceIf> iface) {
...
class TBackendManagerServiceConcurrentClient : virtual public TBackendManagerServiceIf {
 public:
  TBackendManagerServiceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
    setProtocol(prot);
  }
  TBackendManagerServiceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) {
    setProtocol(iprot,oprot);
  }
 private:
  void setProtocol(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) {
