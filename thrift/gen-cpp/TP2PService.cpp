...
::boost::shared_ptr< ::apache::thrift::TProcessor > TP2PServiceProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< TP2PServiceIfFactory > cleanup(handlerFactory_);
  ::boost::shared_ptr< TP2PServiceIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::boost::shared_ptr< ::apache::thrift::TProcessor > processor(new TP2PServiceProcessor(handler));
  return processor;
}
