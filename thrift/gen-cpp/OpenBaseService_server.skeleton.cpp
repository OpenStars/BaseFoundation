...
int main(int argc, char **argv) {
  int port = 9090;
  ::std::shared_ptr<OpenBaseServiceHandler> handler(new OpenBaseServiceHandler());
  ::std::shared_ptr<TProcessor> processor(new OpenBaseServiceProcessor(handler));
