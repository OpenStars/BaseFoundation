...
class StorageMonitorServiceIfSingletonFactory : virtual public StorageMonitorServiceIfFactory {
 public:
  StorageMonitorServiceIfSingletonFactory(const boost::shared_ptr<StorageMonitorServiceIf>& iface) : iface_(iface) {}
 ...
 protected:
  boost::shared_ptr<StorageMonitorServiceIf> iface_;
};
...
class StorageMonitorServiceClient : virtual public StorageMonitorServiceIf, public  ::openstars::base::monitor::MonitorReadServiceClient {
 public:
  StorageMonitorServiceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
     ::openstars::base::monitor::MonitorReadServiceClient(prot, prot) {}
  StorageMonitorServiceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :     ::openstars::base::monitor::MonitorReadServiceClient(iprot, oprot) {}
...
class StorageMonitorServiceProcessor : public  ::openstars::base::monitor::MonitorReadServiceProcessor {
 ...
 public:
  StorageMonitorServiceProcessor(boost::shared_ptr<StorageMonitorServiceIf> iface) :
...
class StorageMonitorServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  StorageMonitorServiceProcessorFactory(const ::boost::shared_ptr< StorageMonitorServiceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< StorageMonitorServiceIfFactory > handlerFactory_;
};
...
class StorageMonitorServiceMultiface : virtual public StorageMonitorServiceIf, public  ::openstars::base::monitor::MonitorReadServiceMultiface {
 public:
  StorageMonitorServiceMultiface(std::vector<boost::shared_ptr<StorageMonitorServiceIf> >& ifaces) : ifaces_(ifaces) {
    std::vector<boost::shared_ptr<StorageMonitorServiceIf> >::iterator iter;
 ...
 protected:
  std::vector<boost::shared_ptr<StorageMonitorServiceIf> > ifaces_;
  StorageMonitorServiceMultiface() {}
  void add(boost::shared_ptr<StorageMonitorServiceIf> iface) {
...
class StorageMonitorServiceConcurrentClient : virtual public StorageMonitorServiceIf, public  ::openstars::base::monitor::MonitorReadServiceConcurrentClient {
 public:
  StorageMonitorServiceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
     ::openstars::base::monitor::MonitorReadServiceConcurrentClient(prot, prot) {}
  StorageMonitorServiceConcurrentClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :     ::openstars::base::monitor::MonitorReadServiceConcurrentClient(iprot, oprot) {}
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> getInputProtocol() {
    return piprot_;
  }
  boost::shared_ptr< ::apache::thrift::protocol::TProtocol> getOutputProtocol() {
