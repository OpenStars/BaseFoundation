...
class cpuStat : public virtual ::apache::thrift::TBase {
 public:
  ...
  cpuStat(const cpuStat&) noexcept;
  cpuStat& operator=(const cpuStat&) noexcept;
  cpuStat() noexcept
          : userCPU(0),
            kernelCPU(0),
            idleCPU(0),
...
class memoryStat : public virtual ::apache::thrift::TBase {
 public:
  ...
  memoryStat(const memoryStat&) noexcept;
  memoryStat& operator=(const memoryStat&) noexcept;
  memoryStat() noexcept
             : totalMem(0),
               freeMem(0),
               usedMem(0),
...
class systemLoad : public virtual ::apache::thrift::TBase {
 public:
  ...
  systemLoad(const systemLoad&) noexcept;
  systemLoad& operator=(const systemLoad&) noexcept;
  systemLoad() noexcept
             : load1m(0),
               load5m(0),
               load15m(0) {
...
class diskStat : public virtual ::apache::thrift::TBase {
 public:
  ...
  diskStat(const diskStat&) noexcept;
  diskStat& operator=(const diskStat&) noexcept;
  diskStat() noexcept
           : readSpeed(0),
             writeSpeed(0) {
  }

  virtual ~diskStat() noexcept;
  int64_t readSpeed;
  int64_t writeSpeed;
...
class networkStat : public virtual ::apache::thrift::TBase {
 public:
  ...
  networkStat(const networkStat&) noexcept;
  networkStat& operator=(const networkStat&) noexcept;
  networkStat() noexcept
              : readSpeed(0),
                writeSpeed(0) {
  }

  virtual ~networkStat() noexcept;
  int64_t readSpeed;
  int64_t writeSpeed;
